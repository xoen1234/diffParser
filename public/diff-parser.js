...
//   filePathEl.textContent = file.newPath || file.oldPath;
  
//   file.chunks.forEach(chunk => {
//     const chunkEl = document.createElement('div');
//     chunkEl.classList.add('diff-chunk');
    
//     const headerEl = document.createElement('div');
//     headerEl.classList.add('diff-chunk-header');
//     headerEl.textContent = chunk.header;
//     chunkEl.appendChild(headerEl);
    
//     let oldLine = parseInt(chunk.header.match(/-(\d+)/)?.[1] || 0);
//     let newLine = parseInt(chunk.header.match(/\+(\d+)/)?.[1] || 0);
    
//     chunk.lines.forEach(line => {
//       const lineEl = document.createElement('div');
//       lineEl.classList.add('diff-line');
      
//       const lineNumOld = document.createElement('div');
//       lineNumOld.classList.add('diff-line-num');
      
//       const lineNumNew = document.createElement('div');
//       lineNumNew.classList.add('diff-line-num');
      
//       const lineContent = document.createElement('div');
//       lineContent.classList.add('diff-line-content');
      
//       if (line.startsWith('+') && !line.startsWith('+++')) {
//         lineEl.classList.add('diff-line-added');
//         lineNumOld.textContent = '';
//         lineNumNew.textContent = newLine++;
//         lineContent.textContent = line.slice(1);
//       } else if (line.startsWith('-') && !line.startsWith('---')) {
//         lineEl.classList.add('diff-line-removed');
//         lineNumOld.textContent = oldLine++;
//         lineNumNew.textContent = '';
//         lineContent.textContent = line.slice(1);
//       } else {
//         lineEl.classList.add('diff-line-neutral');
//         lineNumOld.textContent = oldLine++;
//         lineNumNew.textContent = newLine++;
//         lineContent.textContent = line.startsWith(' ') ? line.slice(1) : line;
//       }
...
//         lineEl.classList.remove('diff-line-highlight');
//       });
      
//       chunkEl.appendChild(lineEl);
//     });
    
//     diffContent.appendChild(chunkEl);
//   });
// }
